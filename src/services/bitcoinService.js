...
const BLOCK_CHAIN_KEY = 'I0kuofKcAXpczi0'

// async function getRate() {
function getRate() {
    // const rate = await axios.get(`https://blockchain.info/tobtc?currency=USD&value=1`)
    const rate = '0.00003266'
    return rate
}
// async function getMarketPriceHistory() {
function getMarketPriceHistory() {
    // const priceHistory = await axios.get(`https://api.blockchain.info/charts/market-price?timespan=5months&format=json&cors=true`)
    const priceHistory = {
        "status": "ok",
